...
void StudentMenu()
{
    ...
    Console.WriteLine("        Student Menu");
    Console.WriteLine("********************");
    Console.Write("Please Select Your Action (1:ChangePass , 2:EntekhabVahed ,3:List of courses ,4:schedule of student 5:LogOut) : ");
    if (!Int32.TryParse(Console.ReadLine(), out int actionId))
    {
        Console.WriteLine("Selected Action Is Invalid.");
        StudentMenu();
    ...
    switch (actionId)
    {
        ...
        case 4:
            Console.Clear();
            Console.WriteLine("**********Courses**********");
            userService.StudentCourse(currentuser);
            Console.WriteLine("***************************");
            Console.ReadKey();
            StudentMenu();
...
void OperatorMenu()
{
    ...
    switch (actionId)
    {
        ...
        case 2:
            ...
            Console.WriteLine(userService.ListInActiveUsers().Message);
            Console.WriteLine("///////////////////////////////////////");
            Console.WriteLine("Enter UserId: ");
            var userId = Int32.Parse(Console.ReadLine());
            string M = userService.ActivateUser(userId);
            Console.WriteLine(M);
            Console.ReadKey();
            OperatorMenu();
            break;
        case 3:
            ...
            Course course = new Course(courseName,courseUnit,capacity,day,startTime,endTime);
...
void Register(string? message = null)
{
    ...
    switch (role)
    {
        case RoleEnum.Student:
            ...
            userService.SetStuId((Student)user);
            break;
        case RoleEnum.Operator:
